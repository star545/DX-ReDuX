...
with (other)
{
	if (key_up && grounded && ((character != characters.pepperman && y == (other.y + 50)) or (character == characters.pepperman && y == (other.y + 55))) && (!instance_exists(obj_fadeout)) && state != states.door && state != states.comingoutdoor && ((obj_player1.spotlight == 1 && object_index == obj_player1) or (obj_player1.spotlight == 0 && object_index == obj_player2)))
	{
