...
timerfont = font_add_sprite_ext(spr_font, "ABCDEFGHIJKLMNOPQRSTUVWXYZ!.1234567890:%", 1, 0)
targetfill = 0
image_speed = 0.1
prompt_timer = 0
chose = 0
...
txt_timer = 0
txt_y = 0
txt_array = ["GRAB", "SHOULDER BASH", "PUMMEL", "ETC"]
txt_timer2 = 0
txt_y2 = 0
txt_array2 = ["KUNG FU", "PISTOL + CHAINSAW", "BREAKDANCE", "ETC"]
