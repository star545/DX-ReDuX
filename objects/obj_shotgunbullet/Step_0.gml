...
if !pierce && (place_meeting((x + (image_xscale * spd)), y, obj_solid) && (!(place_meeting((x + (image_xscale * spd)), y, obj_electricwall))) && (!(place_meeting((x + (image_xscale * spd)), y, obj_shotgunblock))) && (!(place_meeting((x + (image_xscale * spd)), y, obj_destructibles))))
	instance_destroy()
