if (other.object_index == obj_spitcheesespike or other.object_index == obj_bigspitcheesespike || other.object_index == obj_banditochicken_projectile or other.object_index == obj_robotknife)
{
	with (other)
	{
