...
switch state
{
	...
	case 2:
		if (ident == loadid)
		{
			...
			if !ini_key_exists("Version", "Num") || ini_read_real("Version", "Num", 1) < global.version_num {
				var prev_ver = ini_read_real("Version", "Num", 1)
				ini_write_real("Version", "Num", global.version_num) 
				if prev_ver == 1 {
					if ini_section_exists("BabyPeppino") ini_section_delete("BabyPeppino")	
				}
			}
			...
			global.seen_champ_cutscene = ini_read_real("Cutscenes", "champ", 0)
			global.seen_dark_cutscene = ini_read_real("Cutscenes", "dark", 0)
			...
			global.golfmaniatreasure = ini_read_real("Treasure", "golfmania", 0)
			global.bathtreasure = ini_read_real("Treasure", "bath", 0)
