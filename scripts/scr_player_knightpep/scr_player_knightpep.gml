function scr_player_knightpep()
{
	...
	else if (sprite_index == spr_knightpep_attack or sprite_index == spr_knightpepjump or sprite_index == spr_knightpepfall or sprite_index == spr_knightpepdoublejump or sprite_index == spr_knightpepslam)
	{
	...
	if (sprite_index == spr_knightpepslam && vsp >= 0)
		vsp += 0.5
	if key_jump
		input_buffer_jump = 0
	if (grounded && vsp > 0)
	...
	if (grounded && vsp > 0)
		jumpstop = 0
	if (input_buffer_jump < 8 && vsp > 0 && grounded && (sprite_index == spr_knightpepidle or sprite_index == spr_knightpepslam or sprite_index == spr_knightpepland or sprite_index == spr_knightpepwalk))
	{
		image_index = 0
	...
	if ((floor(image_index) == (image_number - 1) && sprite_index == spr_knightpepjump) or ((!grounded) && sprite_index != spr_knightpepjumpstart && sprite_index != spr_knightpepjump && sprite_index != spr_knightpepthunder && sprite_index != spr_knightpepslam && sprite_index != spr_knightpepdoublejump))
		sprite_index = spr_knightpepfall
	if ((sprite_index == spr_knightpepslam or sprite_index == spr_knightpepfall or sprite_index == spr_knightpepdoublejump) && grounded && vsp > 0 && (!scr_slope()))
	{
		with (obj_baddie)
		{
	...
	if !grounded && place_meeting_solid(x + sign(hsp), y) && !groundedSlope
		movespeed = 0
	...
	if (move != 0 && floor(image_index) != 3 && floor(image_index) != 8)
		steppy = 0
	if (sprite_index == spr_knightpepfall or sprite_index == spr_knightpepslam)
	{
		knightmomentum += 0.35
		trace(knightmomentum)
	}
	if (scr_slope() && sprite_index != spr_knightpepthunder && !place_meeting_slopeSolid(x + 1, y) && !place_meeting_slopeSolid(x - 1, y))
	{
		if (sprite_index == spr_knightpepslam)
			movespeed = 11
		else
			movespeed = 8
