function scr_player_firemouth()
{
	...
	if (sprite_index == spr_firemouthintro && floor(image_index) == (image_number - 1))
	{
		...
		scr_controlprompt(concat( prompt_string(global.key_slap), " Dash"))
	}
	...
	if sprite_index == spr_firemouthintro && floor(image_index) == 21
	{
		if !audio_is_playing(sfx_firemouthbegin)
